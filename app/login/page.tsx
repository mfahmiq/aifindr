        ...
        <div className="flex min-h-screen w-full items-center justify-center p-4 bg-gray-50/50">
            <Card className="w-full max-w-[400px] shadow-xl border-none">
                <CardHeader className="text-center pt-8 pb-4">
                    ...
                    <p className="text-base text-slate-600 mt-1">to continue to IndoAI</p>
                </CardHeader>
                    ...
                    {!showEmailForm ? (
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full text-left flex items-center gap-4 p-3 rounded-lg hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all group"
                            >
                                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                                    <Sparkles className="w-5 h-5 text-primary" />
                                </div>
                                <div className="flex-1">
                                    <div className="font-medium text-slate-900 group-hover:text-primary transition-colors">Continue with Google</div>
                                    <div className="text-sm text-slate-500">Fast & Secure</div>
                                </div>
                            </button>
                            ...
                            <button
                                ...
                                className="w-full text-left flex items-center gap-4 p-3 rounded-lg hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all"
                            >
                                <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center shrink-0">
                                    <Mail className="w-5 h-5 text-slate-600" />
                                </div>
                                <div className="flex-1">
                                    <div className="font-medium text-slate-900">Use Email</div>
                                    <div className="text-sm text-slate-500">Traditional login</div>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-sm text-slate-500">Sign up for free</div>
                                </div>
                            </Link>
                        </div>
                    ) : (
