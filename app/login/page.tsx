            ...
            <Card className="w-full max-w-[400px] shadow-xl border-none dark:bg-slate-950 dark:border dark:border-slate-800">
                ...
                <CardContent className="px-8 pb-8">
                    <div className="flex flex-col gap-4">
                        <Button
                            variant="outline"
                            className="w-full h-12 text-base font-medium relative border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900"
                        ...
                        {!showEmail ? (
                            <Button
                                variant="ghost"
                                className="w-full text-slate-600 dark:text-slate-400 font-normal hover:text-slate-900 dark:hover:text-white"
                                ...
                                <Auth
                                    ...
                                    appearance={{
                                        ...
                                        className: {
                                            ...
                                            anchor: 'text-blue-600 !no-underline hover:text-blue-700 font-medium',
                                        }
                                    }}
                                    providers={[]}
                                    ...
                                    showLinks={true}
                                />
                                <Button variant="link" className="w-full mt-2 text-slate-500" onClick={() => setShowEmail(false)}>Cancel</Button>
                            </div>
                        )}
                    </div>
                </CardContent>
